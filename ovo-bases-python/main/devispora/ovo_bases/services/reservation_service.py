...
def incoming_reservation_check(incoming_request: IncomingRequest):
    try:
        ...
        #  For each reservation, determine
        #  which means collect the start-days and continents.
        #  That way we can make a more efficient query for the information we need.
