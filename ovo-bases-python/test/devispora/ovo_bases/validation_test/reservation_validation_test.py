...
class ReservationValidationTest(unittest.TestCase):
    ...
    def test_start_not_in_long_past_negative_incorrect(self):
        ...
        bad_reservation = IncomingRequest(
            facilities=[230],
        ...
        self.assertRaisesRegex(
            ...
            start_not_in_long_past, incoming_request=bad_reservation
        )

    def test_start_not_in_long_past_negative_correct(self):
        now = create_current_epoch()
        ok_reservation = IncomingRequest(
            facilities=[230],
            request_type=RequestType.Reservation,
            reservation_type=ReservationType.Scrim,
            group_name='TEST',
    ...
    def test_starts_before_end_incorrect(self):
        ...
        self.assertRaisesRegex(
            ...
            starts_before_end, incoming_request=bad_reservation
        )
    ...
    def test_starts_before_end_correct(self):
        ...
        self.assertTrue(starts_before_end(incoming_request=ok_reservation))
    ...
    def test_start_not_far_from_end_incorrect(self):
        ...
        self.assertRaisesRegex(
            ...
            start_not_far_from_end, incoming_request=bad_reservation
        )

    def test_start_not_far_from_end_correct(self):
        reservation = IncomingRequest(
            facilities=[230],
            request_type=RequestType.Reservation,
            reservation_type=ReservationType.Scrim,
            group_name='TEST',
